...
export default function Main() {
  ...
  const mockData = [
    ...
    },
    {
      ...
      poster:
        'https://s3-alpha-sig.figma.com/img/a22b/d4f9/779147892922435902d1f33d00b315f8?Expires=1733097600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=R6yOS8HHN5VVDsFn7VpwKovv62Rn3ondplHnwMwNu9itkS9Azxif0n0~XXzZcPG6sSjKoafkvgB5P1pnpBd1KQgFAO52BnRavWEdjs01vGGbHkCS68VxhAay0JMHjwtC4q8A9lT3JH6DU34SoPMHL6LfqHQEnQsFLrh-JOMOhgrLbk3XrLPbgdyJqxGrvCTZlLl0i5wOu88rm-CagAgXPVzuVe3k6oo2CkcGuNVQPB3fzQY9BE50NaqfpNtuTRxaAGkDwozbNE3~Z4n60H8Dd0Uw4Xl9nc-d02PG9obBH4~HjB12GzBkTozVPZJPHIa2F-vCPybag0ZhXzcpYam8QQ__',
    },
  ];
          ...
          {cityData.map((city, index) => (
            ...
            >
              <View className="w-20 h-20 rounded-full bg-gray-300 justify-center items-center overflow-hidden relative">
                {/* 어두운 오버레이 추가 */}
                <View className="absolute inset-0 bg-black opacity-0" />
                {/* 이미지 위에 어두운 오버레이 추가 */}
                <Image
                  source={{ uri: city.image }}
                  className="w-full h-full object-cover"
                />
                <FontText className="absolute text-white font-bold">
                  {city.name}
                </FontText>
              </View>
            </TouchableOpacity>
